...
func CheckCanPickQuantityV4(userID string, req []model.OrderItem, mapItem map[string]model.OrderItem, createMethod string) (res model.CheckValidOrderItemResponse, err error) {
	// Update req quantity
	var tReq []model.OrderItem
	for _, v := range req {
		if mapItem != nil {
